...
//        };
//        String[] choicSubjectseList = new String[anountSubjects];
//
...
////                    .pressEnter();
//
//            for (String choicSubject : choicSubjectseList){
//                if (choicSubject == subjectsList[randomNumber]){
//                    randomNumber = (int) (Math.random() * subjectsList.length);
//                }
//            }
//            choicSubjectseList[i] = subjectsList[randomNumber];
//
//
